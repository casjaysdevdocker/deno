...
```shell
dockerHome="/srv/$USER/docker/casjaysdevdocker/deno/deno/latest/rootfs"
mkdir -p "/srv/$USER/docker/deno/rootfs"
...
services:
  ProjectName:
    ...
    environment:
      ...
      - HOSTNAME=deno
    volumes:
      - "/srv/$USER/docker/casjaysdevdocker/deno/deno/latest/rootfs/data:/data:z"
      - "/srv/$USER/docker/casjaysdevdocker/deno/deno/latest/rootfs/config:/config:z"
    ports:
      - 80:80
    restart: always
```
